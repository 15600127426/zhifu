 ...
 */
package org.xxpay.mgr.permission.controller;

import com.roncoo.pay.common.core.dwz.DwzAjax;
import com.roncoo.pay.common.core.page.PageBean;
import com.roncoo.pay.common.core.page.PageParam;
import org.xxpay.mgr.controller.common.BaseController;
...
import org.xxpay.mgr.permission.enums.OperatorTypeEnum;
import org.xxpay.mgr.permission.service.*;
import org.xxpay.mgr.permission.utils.ValidateUtils;
...
public class PmsRoleController extends BaseController {
    ...
    public String addPmsRole(HttpServletRequest req, Model model, @RequestParam("roleCode") String roleCode, @RequestParam("roleName") String roleName, @RequestParam("remark") String remark, DwzAjax dwz) {
        try {
            ...
            pmsRole.setRole_code(roleCode);
            pmsRole.setRole_name(roleName);
            pmsRole.setRemark(remark);
            pmsRole.setCreate_time(new Date());
    ...
    private String validatePmsRole(PmsRole pmsRole) {
        ...
        String roleName = pmsRole.getRole_name(); // 角色名称
    ...
    public String editPmsRole(HttpServletRequest req, Model model, PmsRole role, DwzAjax dwz) {
        try {
            ...
            PmsRole roleNameCheck = pmsRoleService.getByRoleNameOrRoleCode(role.getRole_name(), null);
            if (roleNameCheck != null && !roleNameCheck.getId().equals(id)) {
                return operateError("角色名【" + role.getRole_name() + "】已存在", model);
            }

            PmsRole roleCodeCheck = pmsRoleService.getByRoleNameOrRoleCode(null, role.getRole_code());
            if (roleCodeCheck != null && !roleCodeCheck.getId().equals(id)) {
                return operateError("角色编码【" + role.getRole_code() + "】已存在", model);
            }
