...
import org.xxpay.mgr.permission.biz.PmsMenuBiz;
import org.xxpay.dal.dao.model.PmsMenu;
import org.xxpay.mgr.permission.service.PmsMenuService;
	...
	public String delPmsMenu(HttpServletRequest req, Long menuId, Model model, DwzAjax dwz) {
		try {
			...
			if (childList == null || childList.isEmpty()) {
				...
				parent.setIs_leaf(PublicEnum.YES.name());
