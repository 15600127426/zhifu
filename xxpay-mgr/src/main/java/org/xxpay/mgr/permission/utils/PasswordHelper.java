 ...
 */
package org.xxpay.mgr.permission.utils;
...
public class PasswordHelper {
	...
	public static void encryptPassword(PmsOperator pmsOperator) {
		...
		String newPassword = new SimpleHash(algorithmName, pmsOperator.getLogin_pwd(), ByteSource.Util.bytes(pmsOperator.getCredentialsSalt()), hashIterations).toHex();

		pmsOperator.setLogin_pwd(newPassword);
	}
