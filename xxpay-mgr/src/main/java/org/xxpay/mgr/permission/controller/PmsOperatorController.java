...
import org.xxpay.mgr.permission.service.PmsOperatorRoleService;
import org.xxpay.mgr.permission.service.PmsOperatorService;
import org.xxpay.mgr.permission.service.PmsRoleService;
	...
	public String viewPmsOperatorUI(HttpServletRequest req, Long id, Model model) {
		try {
			...
			for (PmsRoleOperator pmsOperatorRole : lisPmsOperatorRoles) {
				owenedRoleIdBuffer.append(pmsOperatorRole.getRole_id());
