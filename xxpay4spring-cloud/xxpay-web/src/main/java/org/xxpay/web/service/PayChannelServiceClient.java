...
public class PayChannelServiceClient {
    ...
    public  String getActiveChannel(String ChannelName){
         return restTemplate.getForEntity("http://XXPAY-SERVICE/pay_channel/getRandomChannel?jsonParam=" + MyBase64.encode(ChannelName.getBytes()), String.class).getBody();
    }
