...
public class PayOrderController {
    ...
    public String payOrder(@RequestBody String params) {
        ...
        try {
            ...
            //根据渠道选择一个channelId
            JSONObject js=JSONObject.parseObject(payChannelServiceClient.getActiveChannel(payOrder.getString("channelName")));
            String channelId = js.getString("channelId");
